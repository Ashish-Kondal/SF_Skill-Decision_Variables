...
input_dir <- paste("sample_data/", sep="")  			 # Setting input directory 
...
huc6_shapefile_address <- paste("Shapefiles/PNW_Shapefile_USonly/pnw_shapefile_USonly.shp", sep="")		# PNW's shapefile at HUC06 Level
wa_shapefile_address <- paste("Shapefiles/WA_Shapefile/WA_State_Boundary.shp", sep="")				# Shapefile of Washington state
or_shapefile_address <- paste("Shapefiles/OR_Shapefile/Oregon.shp", sep="")					# Shapefile of Oregon state
id_shapefile_address <- paste("Shapefiles/Idaho_shapefile/Shape/GU_StateOrTerritory.shp", sep="")		# Shapefile of Idaho state
...
elev_inputfilename <- paste("PNW_Elevation.txt",sep="") 						# path to elevation file	
